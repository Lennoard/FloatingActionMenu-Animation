...
public class FloatingActionsMenu extends ViewGroup {
    ...
    private void init(Context context, AttributeSet attributeSet) {
        mButtonSpacing = (int) (getResources().getDimension(toan.android.floatingactionmenu.R.dimen.fab_actions_spacing) - getResources().getDimension(toan.android.floatingactionmenu.R.dimen.fab_shadow_radius) - getResources().getDimension(toan.android.floatingactionmenu.R.dimen.fab_shadow_offset));
        mLabelsMargin = getResources().getDimensionPixelSize(toan.android.floatingactionmenu.R.dimen.fab_labels_margin);
        ...
        TypedArray attr = context.obtainStyledAttributes(attributeSet, toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu, 0, 0);
//        mAddButtonPlusColor = attr.getColor(toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu_fab_addButtonPlusIconColor, getColor(android.R.color.white));
        mAddButtonColorNormal = attr.getColor(toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu_fab_addButtonColorNormal, getColor(toan.android.floatingactionmenu.R.color.default_normal));
        mAddButtonColorPressed = attr.getColor(toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu_fab_addButtonColorPressed, getColor(toan.android.floatingactionmenu.R.color.default_pressed));
        mAddButtonSize = attr.getInt(toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu_fab_addButtonSize, FloatingActionButton.SIZE_NORMAL);
        mAddButtonStrokeVisible = attr.getBoolean(toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu_fab_addButtonStrokeVisible, true);
        mExpandDirection = attr.getInt(toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu_fab_expandDirection, EXPAND_UP);
        mLabelsStyle = attr.getResourceId(toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu_fab_labelStyle, 0);
        mLabelsPosition = attr.getInt(toan.android.floatingactionmenu.R.styleable.FloatingActionsMenu_fab_labelsPosition, LABELS_ON_LEFT_SIDE);
        mAnimScroll = attr.getInt(R.styleable.FloatingActionsMenu_fab_animationScroll, FabAnimationUtils.ANIM_NONE);
        mDrawableIcon = attr.getDrawable(R.styleable.FloatingActionsMenu_fab_menuIcon);
...
//                mPlusColor = mAddButtonPlusColor;
            ...
            Drawable getIconDrawable() {
                ...
                final RotatingDrawable rotatingDrawable = new RotatingDrawable(mDrawableIcon);
        ...
        mAddButton.setId(toan.android.floatingactionmenu.R.id.fab_expand_menu_button);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            if (!expandsHorizontally()) {
                TextView label = (TextView) child.getTag(toan.android.floatingactionmenu.R.id.fab_label);
                if (label != null) {
        ...
        switch (mExpandDirection) {
            ...
            case EXPAND_DOWN:
                ...
                for (int i = mButtonsCount - 1; i >= 0; i--) {
                    ...
                    View label = (View) child.getTag(toan.android.floatingactionmenu.R.id.fab_label);
                    if (label != null) {
    ...
    private void createLabels() {
        ...
        for (int i = 0; i < mButtonsCount; i++) {
            ...
            if (button == mAddButton || title == null ||
                    button.getTag(toan.android.floatingactionmenu.R.id.fab_label) != null) continue;
            ...
            button.setTag(toan.android.floatingactionmenu.R.id.fab_label, label);
        }
    }
